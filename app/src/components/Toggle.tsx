...
export const Toggle = ({ tabOneText, tabTwoText, tabOneComponent, tabTwoComponent }): JSX.Element => {
    ...
    const handleSlide = (type: number) => {
        const { active, xTabOne, xTabTwo, translateX, translateXTabOne, translateXTabTwo } = state;
            ...
            >
                ...
                >
                    ...
                    >
                        <Text
                            style={{
                                color: state.active === 0 ? "#98B5FF" : "#fff"
                            }}
                        >
                            {tabOneText}
                        </Text>
                    ...
                    >
                        <Text
                            style={{
                                color: state.active === 1 ? "#98B5FF" : "#fff"
                            }}
                        >
                            {tabTwoText}
                        </Text>
